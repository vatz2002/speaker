        ...
        <>
            <div className='bg-brandDark text-white py-4 font-varela'>
                <motion.nav initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.5 }} className='container flex justify-between items-center'>
                    <div>
                        <a href='#' className='text-xl font-bold uppercase'>Playing / <span className='font-extralight text-white 70'>Market</span>
                        </a>
                    </div>
                                ...
                                NavbarMenu.map((item) => (
                                    <li key={item.id}>
                                        <UpdateFollower
                                            ...
                                            <a href={item.link} className='inline-block text-sm py-2 px-3 uppercaser'>
                                                {item.title}
                                            </a>
                                        </UpdateFollower>
                                    </li>
